...
// released jfx-static-libs:27 jars + jfx27-metadata:
// * graphics 775 (jni 166, reflect 594, res 15),
// * web 146, media 31, controls 10, richtext 9, base 5, swing 2, fxml 1, input 1
// = 980 total; annotations 317 in 282 files (graphics 226/196, web 59/55).
