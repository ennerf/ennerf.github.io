...
Historically, the glass library in OpenJFX reported lower JNI versions. Since GraalVM 25 strictly enforces https://openjdk.org/jeps/178[JEP 178]'s minimum `JNI_VERSION_1_8` for static linking, the official sources are not compatible until this is updated upstream.
