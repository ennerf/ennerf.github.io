...
:page-tags: Latency, Ethernet, UDP, real-time control
:page-image: { path: /images/udp/multiple-boards.jpg, alt: "Network test setup with 40 HEBI Robotics I/O Boards" }
