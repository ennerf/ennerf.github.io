...
A better way to look at latency is via histograms and percentile plots, e.g., 99.9% of measurements have been below 1ms. Recording these takes more effort, but luckily there are some great libraries. 
