...
NOTE: TODO: should this blog be about real-time control or more focused on latency?
...
Let's first look at the main consumer operating systems: Windows, Mac and Linux. I've done a clean install for each OS, disabled sleep mode, and performed any steps necessary to start jHiccup. Other than that, there were no other modifications. After starting, I've unplugged all cables other than the power cable and let the computer sit idle for >24 hours.
