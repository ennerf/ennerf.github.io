...
//Traditional networking work focuses on large, ad-hoc networks that typically exhibit very different topologies and traffic patterns than networks used to control robotic systems. Thus, the issues that are found in these networks are different.

//Traditional networking work focuses on large, ad-hoc networks that may have multiple routes between source and destination. The network toplogies and traffic patterns used to control robotic systems are much more controlled, so several issues commonly found in large scale networks don't apply to this use case.

//The network topologies and traffic patterns used to control robotic systems are much more controlled than for example streaming a video through the Internet. Thus, several issues commonly found in large scale networks are not applicable to this use case. 

//The network topologies and traffic patterns used to control robotic systems exhibit different characteristics than found in traditional networking work that focuses on large, ad-hoc networks. 
