...
:page-tags: Latency, Operating System, Windows, OSX, Ubuntu, Scientific Linux, Sleep, Real-Time, HdrHistogram
:page-image: { path: /images/os/latency-social-card.png, alt: "Latency percentile distribution of Windows, macOS, and Ubuntu over 24 hours" }
